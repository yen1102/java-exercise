...
public class info {
    ...
    private void initializeInfoFrame() {
        ...
        // 聊天
        JLabel entertainment = new JLabel("貓貓娛樂中心:");
        entertainment.setForeground(Color.orange);

        JPanel chat = new JPanel();
        JLabel chatLabel = new JLabel("來聊天         ");

        chatroomButton = new JButton("進入聊天室");
        chat.add(chatLabel);
        chat.add(chatroomButton);
        //
        ...
        chatroomButton.addActionListener(listener);
    ...
    private class MyEventListner implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            } else if (e.getSource() == chatroomButton) {
    ...
    private void client() {
        try {
            client = new ChatClient("127.0.0.1");
            client.run();
